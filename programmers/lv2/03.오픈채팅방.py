...
def solution(record):
    ...
    for sentence in record:
        ...
        if sentence[0] == "Enter":
            userDict[sentence[1]] = sentence[2]
    ...
    for sentence in record:
        sentence = sentence.split(" ")
        if sentence[0] == "Enter":
            result.append(userDict[sentence[1]] + "님이 들어왔습니다.")
        elif sentence[0] == "Leave":
            result.append(userDict[sentence[1]] + "님이 나갔습니다.")
    return result


#for문을 두번돌려서 위에는 id별 닉네임 확정 , 아래는 각 명령어를 구분해 결과값 담기
